...
// else printf ("fm: not connected\n");
    break;

  case HOST_DEV_ATTACHED :
// printf ("fm: HOST_DEV_ATTACHED\n");
...
// printf ("fm: HOST_CLASS\n");
  ...
  case HOST_CTRL_XFER:
// printf ("fm: HOST_CTRL_XFER\n");
    /* process control transfer state machine */
    USBH_HandleControl(pdev, phost);
    break;

  case HOST_SUSPENDED:
// printf ("fm: HOST_SUSPENDED\n");
    break;

  case HOST_ERROR_STATE:
// printf ("fm: HOST_ERROR_STATE\n");
...
// printf ("fm: HOST_DEV_DISCONNECTED\n");
...
// printf ("fm phost: CTRL_SETUP_WAIT\n");

    URB_Status = HCD_GetURB_State(pdev , phost->Control.hc_num_out);
    /* case SETUP packet sent successfully */
{
   static int last_URB_Status = 0xFFFF;
   if (last_URB_Status != URB_Status)
   {
//        printf ("fm phost: URB_Status=%d\n", URB_Status);
        last_URB_Status = URB_Status;
   }
}
...
// printf ("fm phost: CTRL_DATA_IN_WAIT\n");
...
// printf ("fm phost: CTRL_DATA_OUT_WAIT\n");
  ...
  case CTRL_STATUS_IN:
// printf ("fm phost: CTRL_STATUS_IN\n");
...
// printf ("fm phost: CTRL_STATUS_IN_WAIT\n");
...
// printf ("fm phost: CTRL_STATUS_OUT\n");
    pdev->host.hc[phost->Control.hc_num_out].toggle_out ^= 1;
    USBH_CtlSendData (pdev,
                      0,
                      0,
...
// printf ("fm phost: CTRL_STATUS_OUT_WAIT\n");
